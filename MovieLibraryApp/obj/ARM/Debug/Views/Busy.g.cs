#pragma checksum "C:\Users\Jonas\source\repos\MovieLibraryApp\MovieLibraryApp\Views\Busy.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "FAD8CEABBAA215ED30C6386039497106"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MovieLibraryApp.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::MovieLibraryApp.Views.Busy dataRoot;
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::MovieLibraryApp.Views.Busy)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::MovieLibraryApp.Views.Busy obj, int phase)
            {
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::MovieLibraryApp.Views.Busy obj = sender as global::MovieLibraryApp.Views.Busy;
                        if (obj != null)
                        {
                ...
                public void UpdateChildListeners_(global::MovieLibraryApp.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if (WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::MovieLibraryApp.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::MovieLibraryApp.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::MovieLibraryApp.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::MovieLibraryApp.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
